...
let service = {
    ...
    "#service2":{
        ...
        "content":"Getting your music on playlists is the fastest way to grow streams and fans. At The Boss Music Distribution & Marketing, we help artists land on both Editorial and Curated playlists.

Editorial Playlists → Official playlists by Spotify, Apple Music, Audiomack, Boomplay, etc. (e.g. RapCaviar, Afrobeats Hits). We pitch your songs directly to DSP editors for maximum exposure.

Curated Playlists → Managed by influencers, DJs, blogs & brands. We connect your music with the right tastemakers to reach real listeners who engage.

👉 With our playlisting service, your track gets visibility, streams, and credibility.
